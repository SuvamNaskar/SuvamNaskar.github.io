          ...
          <div className="brutalist-card h-full overflow-hidden flex flex-col hover:-translate-y-1 transition-all duration-100">
            ...
            <div className="p-6 md:p-8 space-y-6 flex-grow flex flex-col justify-between">
              {certificationsList.map((cert, idx) => (
                <div key={idx} className="space-y-4 flex-grow flex flex-col justify-between">
                  ...
                  {cert.verifyUrl && (
                    <div className="pl-14 pt-2">
                      <a
                        ...
                        className="brutalist-button inline-flex items-center space-x-2 px-4 py-2 font-mono text-[10px] font-bold uppercase tracking-wider text-black bg-[#ffe680] hover:bg-[#ffde59]"
                      >
